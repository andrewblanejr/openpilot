...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 2500.  # a first alert is issued 25s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 1500.  # a second alert is issued 15s before start decelerating the car
